...
export const schoolsSubjectsRetrieve = <ThrowOnError extends boolean = false>(options: Options<SchoolsSubjectsRetrieveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SchoolsSubjectsRetrieveResponse, unknown, ThrowOnError>({
