...
/**
 * Smart import for a specific school
 * Automatically fetches missing data and imports everything needed for a school
 */
export const importSchoolSmart = <ThrowOnError extends boolean = false>(options: Options<ImportSchoolSmartData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ImportSchoolSmartResponse, ImportSchoolSmartError, ThrowOnError>({
