...
import type { DataMaintenanceTasksListData, DataMaintenanceTasksListResponse, DataMaintenanceTasksCreateData, DataMaintenanceTasksCreateResponse, DataMaintenanceTasksDestroyData, DataMaintenanceTasksDestroyResponse, DataMaintenanceTasksRetrieveData, DataMaintenanceTasksRetrieveResponse, DataMaintenanceTasksPartialUpdateData, DataMaintenanceTasksPartialUpdateResponse, DataMaintenanceTasksUpdateData, DataMaintenanceTasksUpdateResponse, FetchGroupsFeideRetrieveData, FetchSchoolImportStatusRetrieveData, FetchUsersFeideRetrieveData, GoalsListData, GoalsListResponse, GoalsCreateData, GoalsCreateResponse, GoalsDestroyData, GoalsDestroyResponse, GoalsRetrieveData, GoalsRetrieveResponse, GoalsPartialUpdateData, GoalsPartialUpdateResponse, GoalsUpdateData, GoalsUpdateResponse, GroupsListData, GroupsListResponse, GroupsCreateData, GroupsCreateResponse, GroupsDestroyData, GroupsDestroyResponse, GroupsRetrieveData, GroupsRetrieveResponse, GroupsPartialUpdateData, GroupsPartialUpdateResponse, GroupsUpdateData, GroupsUpdateResponse, ImportSchoolFeideCreateData, ImportSchoolGroupsAndUsersCreateData, MasterySchemasListData, MasterySchemasListResponse, MasterySchemasCreateData, MasterySchemasCreateResponse, MasterySchemasDestroyData, MasterySchemasDestroyResponse, MasterySchemasRetrieveData, MasterySchemasRetrieveResponse, MasterySchemasPartialUpdateData, MasterySchemasPartialUpdateResponse, MasterySchemasUpdateData, MasterySchemasUpdateResponse, ObservationsListData, ObservationsListResponse, ObservationsCreateData, ObservationsCreateResponse, ObservationsDestroyData, ObservationsDestroyResponse, ObservationsRetrieveData, ObservationsRetrieveResponse, ObservationsPartialUpdateData, ObservationsPartialUpdateResponse, ObservationsUpdateData, ObservationsUpdateResponse, PingRetrieveData, RolesListData, RolesListResponse, RolesCreateData, RolesCreateResponse, RolesDestroyData, RolesDestroyResponse, RolesRetrieveData, RolesRetrieveResponse, RolesPartialUpdateData, RolesPartialUpdateResponse, RolesUpdateData, RolesUpdateResponse, SchoolsListData, SchoolsListResponse, SchoolsCreateData, SchoolsCreateResponse, SchoolsDestroyData, SchoolsDestroyResponse, SchoolsRetrieveData, SchoolsRetrieveResponse, SchoolsPartialUpdateData, SchoolsPartialUpdateResponse, SchoolsUpdateData, SchoolsUpdateResponse, SituationsListData, SituationsListResponse, SituationsCreateData, SituationsCreateResponse, SituationsDestroyData, SituationsDestroyResponse, SituationsRetrieveData, SituationsRetrieveResponse, SituationsPartialUpdateData, SituationsPartialUpdateResponse, SituationsUpdateData, SituationsUpdateResponse, StatusListData, StatusListResponse, StatusCreateData, StatusCreateResponse, StatusDestroyData, StatusDestroyResponse, StatusRetrieveData, StatusRetrieveResponse, StatusPartialUpdateData, StatusPartialUpdateResponse, StatusUpdateData, StatusUpdateResponse, SubjectsListData, SubjectsListResponse, SubjectsCreateData, SubjectsCreateResponse, SubjectsDestroyData, SubjectsDestroyResponse, SubjectsRetrieveData, SubjectsRetrieveResponse, SubjectsPartialUpdateData, SubjectsPartialUpdateResponse, SubjectsUpdateData, SubjectsUpdateResponse, UserGroupsListData, UserGroupsListResponse, UserGroupsCreateData, UserGroupsCreateResponse, UserGroupsDestroyData, UserGroupsDestroyResponse, UserGroupsRetrieveData, UserGroupsRetrieveResponse, UserGroupsPartialUpdateData, UserGroupsPartialUpdateResponse, UserGroupsUpdateData, UserGroupsUpdateResponse, UserSchoolsListData, UserSchoolsListResponse, UserSchoolsCreateData, UserSchoolsCreateResponse, UserSchoolsDestroyData, UserSchoolsDestroyResponse, UserSchoolsRetrieveData, UserSchoolsRetrieveResponse, UserSchoolsPartialUpdateData, UserSchoolsPartialUpdateResponse, UserSchoolsUpdateData, UserSchoolsUpdateResponse, UsersListData, UsersListResponse, UsersCreateData, UsersCreateResponse, UsersDestroyData, UsersDestroyResponse, UsersRetrieveData, UsersRetrieveResponse, UsersPartialUpdateData, UsersPartialUpdateResponse, UsersUpdateData, UsersUpdateResponse, AuthStatusRetrieveData } from './types.gen';
...
export const dataMaintenanceTasksList = <ThrowOnError extends boolean = false>(options?: Options<DataMaintenanceTasksListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<DataMaintenanceTasksListResponse, unknown, ThrowOnError>({
...
export const dataMaintenanceTasksCreate = <ThrowOnError extends boolean = false>(options: Options<DataMaintenanceTasksCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<DataMaintenanceTasksCreateResponse, unknown, ThrowOnError>({
...
export const dataMaintenanceTasksDestroy = <ThrowOnError extends boolean = false>(options: Options<DataMaintenanceTasksDestroyData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DataMaintenanceTasksDestroyResponse, unknown, ThrowOnError>({
...
export const dataMaintenanceTasksRetrieve = <ThrowOnError extends boolean = false>(options: Options<DataMaintenanceTasksRetrieveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<DataMaintenanceTasksRetrieveResponse, unknown, ThrowOnError>({
        url: '/api/data-maintenance-tasks/{id}/',
        ...options
    });
};
...
export const dataMaintenanceTasksPartialUpdate = <ThrowOnError extends boolean = false>(options: Options<DataMaintenanceTasksPartialUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<DataMaintenanceTasksPartialUpdateResponse, unknown, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        url: '/api/data-maintenance-tasks/{id}/',
        ...options,
        headers: {
...
export const dataMaintenanceTasksUpdate = <ThrowOnError extends boolean = false>(options: Options<DataMaintenanceTasksUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<DataMaintenanceTasksUpdateResponse, unknown, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        url: '/api/data-maintenance-tasks/{id}/',
        ...options,
        headers: {
 ...
 */
export const fetchGroupsFeideRetrieve = <ThrowOnError extends boolean = false>(options: Options<FetchGroupsFeideRetrieveData, ThrowOnError>) => {
 ...
 */
export const fetchSchoolImportStatusRetrieve = <ThrowOnError extends boolean = false>(options: Options<FetchSchoolImportStatusRetrieveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<unknown, unknown, ThrowOnError>({
 ...
 */
export const fetchUsersFeideRetrieve = <ThrowOnError extends boolean = false>(options: Options<FetchUsersFeideRetrieveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<unknown, unknown, ThrowOnError>({
 ...
 */
export const importSchoolFeideCreate = <ThrowOnError extends boolean = false>(options: Options<ImportSchoolFeideCreateData, ThrowOnError>) => {
 ...
 */
export const importSchoolGroupsAndUsersCreate = <ThrowOnError extends boolean = false>(options: Options<ImportSchoolGroupsAndUsersCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
...
export const masterySchemasList = <ThrowOnError extends boolean = false>(options?: Options<MasterySchemasListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<MasterySchemasListResponse, unknown, ThrowOnError>({
...
export const masterySchemasCreate = <ThrowOnError extends boolean = false>(options?: Options<MasterySchemasCreateData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<MasterySchemasCreateResponse, unknown, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        url: '/api/mastery-schemas/',
        ...options,
        headers: {
...
export const masterySchemasDestroy = <ThrowOnError extends boolean = false>(options: Options<MasterySchemasDestroyData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<MasterySchemasDestroyResponse, unknown, ThrowOnError>({
...
export const masterySchemasRetrieve = <ThrowOnError extends boolean = false>(options: Options<MasterySchemasRetrieveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<MasterySchemasRetrieveResponse, unknown, ThrowOnError>({
        url: '/api/mastery-schemas/{id}/',
        ...options
    });
};
...
export const masterySchemasPartialUpdate = <ThrowOnError extends boolean = false>(options: Options<MasterySchemasPartialUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<MasterySchemasPartialUpdateResponse, unknown, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        url: '/api/mastery-schemas/{id}/',
        ...options,
        headers: {
...
export const masterySchemasUpdate = <ThrowOnError extends boolean = false>(options: Options<MasterySchemasUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<MasterySchemasUpdateResponse, unknown, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        url: '/api/mastery-schemas/{id}/',
        ...options,
        headers: {
...
export const userSchoolsList = <ThrowOnError extends boolean = false>(options: Options<UserSchoolsListData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<UserSchoolsListResponse, unknown, ThrowOnError>({
...
export const userSchoolsDestroy = <ThrowOnError extends boolean = false>(options: Options<UserSchoolsDestroyData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<UserSchoolsDestroyResponse, unknown, ThrowOnError>({
...
export const userSchoolsRetrieve = <ThrowOnError extends boolean = false>(options: Options<UserSchoolsRetrieveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<UserSchoolsRetrieveResponse, unknown, ThrowOnError>({
        url: '/api/user-schools/{id}/',
        ...options
    });
};
...
export const userSchoolsPartialUpdate = <ThrowOnError extends boolean = false>(options: Options<UserSchoolsPartialUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<UserSchoolsPartialUpdateResponse, unknown, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        url: '/api/user-schools/{id}/',
        ...options,
        headers: {
...
export const userSchoolsUpdate = <ThrowOnError extends boolean = false>(options: Options<UserSchoolsUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UserSchoolsUpdateResponse, unknown, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        url: '/api/user-schools/{id}/',
        ...options,
        headers: {
