 ...
 */
export const deleteSchoolData = <ThrowOnError extends boolean = false>(options: Options<DeleteSchoolDataData, ThrowOnError>) => (options.client ?? client).post<DeleteSchoolDataResponses, unknown, ThrowOnError>({
