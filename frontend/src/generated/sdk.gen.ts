 ...
 *
 * Returns the list of Feide groups that would be newly created on import (i.e. fetched but not yet in the database).
 */
 ...
 *
 * Returns the list of memberships (user+group+role combinations) that would be newly created on import.
 */
 ...
 *
 * Returns the list of Feide users that would be newly created on import (i.e. fetched but not yet in the database).
 */
