...
export const statusGoalsList = <ThrowOnError extends boolean = false>(options?: Options<StatusGoalsListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<StatusGoalsListResponse, unknown, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'sessionid',
...
export const statusGoalsCreate = <ThrowOnError extends boolean = false>(options: Options<StatusGoalsCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<StatusGoalsCreateResponse, unknown, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                in: 'cookie',
...
export const statusGoalsDestroy = <ThrowOnError extends boolean = false>(options: Options<StatusGoalsDestroyData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<StatusGoalsDestroyResponse, unknown, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'sessionid',
...
export const statusGoalsRetrieve = <ThrowOnError extends boolean = false>(options: Options<StatusGoalsRetrieveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<StatusGoalsRetrieveResponse, unknown, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'sessionid',
...
export const statusGoalsPartialUpdate = <ThrowOnError extends boolean = false>(options: Options<StatusGoalsPartialUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<StatusGoalsPartialUpdateResponse, unknown, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                in: 'cookie',
...
export const statusGoalsUpdate = <ThrowOnError extends boolean = false>(options: Options<StatusGoalsUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<StatusGoalsUpdateResponse, unknown, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                in: 'cookie',
 ...
 */
export const statusGoalsRetrieve2 = <ThrowOnError extends boolean = false>(options: Options<StatusGoalsRetrieve2Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<StatusGoalsRetrieve2Response, unknown, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'sessionid',
